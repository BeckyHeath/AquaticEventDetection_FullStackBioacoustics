...
def plotUMAP_Continuous(audioEmbeddingsList, percentiles, title, colormap, classNames=None):
	"""
...
#	print(audioEmbeddings)
	...
	data_fname = '/Users/ianbick/Documents/GitHub/PhD_WorkPackageOne/VGGish_Embeddings/embeddingsList_audioMothExample.pickle'
	with open(data_fname, 'rb') as savef:
	...
	percentiles = 10
	plotUMAP_Continuous(df['embeddings'].tolist(), percentiles, '630 - 640 AM', 'plasma')
